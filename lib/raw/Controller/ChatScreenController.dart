...
//   final Map<String, String> headers = {'x-api-key': "sec_UF4cBRlukLSqvWOqbxIvLZs9pFPaKeGT"}; //dotenv.env["API_KEY"]!.toString()};
//
...
//
//
//   Future<void> fetchUrlfromNetwork() async {
//
//     try{
//       final response = await
//       http.get(Uri.parse("${BookStoreController.BASE_URL}/api/extractBooks/${bookUid.value}"),headers: {
...
//     try {
//       final response = await http.get(Uri.parse('${BookStoreController.BASE_URL}$url'),
//           headers: {
//             'Content-Type': 'application/json',
//             'Authorization': 'Token ${await getToken()}', // Pass token if needed
//           }
...
//         'x-api-key': "sec_UF4cBRlukLSqvWOqbxIvLZs9pFPaKeGT",//dotenv.env["API_KEY"].toString(),
//         'Content-Type': 'application/json',
//       };
//
